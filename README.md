...
- [X] Mettre en place une infrastructure avec l'implémentation de votre choix (in-memory, sqlite, ...) pour persister les données.
- [X] Pouvoir placer un ordre de commande.
